const socialLinks = [
    ...
    {
      href: "https://twitter.com/natlparkservice",
  ...
  return (
      <footer>
          ...
          <div className="footer-title">
              <p>California's National Parks</p>
          </div>
          ...
          <div className="footer-content">
            ...
            <div className="legal">
                <ul>
                    <li><a href="https://www.nps.gov/aboutus/privacy.htm" target="_blank" rel="noreferrer">Privacy Policy</a></li>
                    <li><a href="https://www.nps.gov/aboutus/disclaimer.htm" target="_blank" rel="noreferrer">Terms and Conditions</a></li>
                </ul>
            ...
            <div className="social">
                <ul>
                    {/* Create SocialLinks from variables */}
                    {socialLinks.map(link => (
                    <li key={link.label}>
                        <a href={link.href} target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-label={link.label}>
                            <path d={link.svgPath} />
                        </svg>
                        </a>
                    </li>
